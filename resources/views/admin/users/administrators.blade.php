...
<div class="page-header-content header-elements-md-inline">
    <div class="page-title d-flex">
        <h4><i class="icon-arrow-left52 ml-2"></i> <span class="font-weight-semibold">Administrators</span></h4>
...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">Administrators datatable</h5>
                    ...
                    <td>
                        ...
                        @else
                            @foreach ($user->groups as $group)
                                <a href="{{ route('admin.groups.show', [$group->id]) }}" class="badge badge-flat border-grey text-grey-600">
                                    {{ $group->title }}
                                </a>
                            @endforeach
                        @endif
