            ...
            <div class="row">
                <div class="col-lg-12">
					...
					<div class="card">
						...
						<div class="card-body">
                            <form method="post" class="form-horizontal form-validate-jquery" action="{{ route('admin.users.settings.store', ['user' => $user->id]) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary">Submit <i class="icon-arrow-right14 mr-2"></i></button>
                                        </div>
                                    </div>
                                </div>
							</form>
