                ...
                <div class="tab-pane fade in active" id="settings">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Create new user setting</h5>
							<div class="heading-elements">
								<ul class="icons-list">
						...
						<div class="panel-body">
                            <form method="post" class="form-horizontal form-validate-jquery" action="{{ route('admin.profile.settings.store', ['user' => $user->id]) }}">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="text-left">
                                            <a href="{{ route('admin.profile.settings.index', ['user' => $user->id]) }}" class="btn btn-default"><i class="icon-arrow-left52 position-left"></i> Back</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
