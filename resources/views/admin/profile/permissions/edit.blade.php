            ...
            <div class="col-lg-12">
					...
					<div class="card">
						<div class="card-header header-elements-inline">
							<h5 class="card-title">Edit user permission</h5>
							<div class="header-elements">
						...
						<div class="card-body">
                            <form method="post" class="form-horizontal form-validate-jquery" action="{{ route('admin.profile.permissions.update', ['user' => $user->id, 'permission' => $permission->id]) }}">
                                {{ method_field('PUT') }}
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="text-left">
                                            <a href="{{ route('admin.profile.permissions.index', ['user' => $user->id]) }}" class="btn btn-default"><i class="icon-arrow-left52 position-left"></i> Back</a>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
