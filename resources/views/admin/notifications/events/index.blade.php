                ...
                <td class="text-center">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="#"><i class="icon-file-pdf"></i> Export to .pdf</a></li>
                                <a class="dropdown-item" href="#"><i class="icon-file-excel"></i> Export to .csv</a></li>
                                <a class="dropdown-item" href="#"><i class="icon-file-word"></i> Export to .doc</a></li>
                            </ul>
                        </div>
                </td>
            </tr>
