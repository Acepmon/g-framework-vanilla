...
<div class="page-header-content">
    <div class="page-title">
        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Edit {{ ucfirst($taxonomy->taxonomy) }} Meta Details</span></h4>
    </div>
...
<div class="breadcrumb-line">
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('admin.taxonomy.index', ['taxonomy' => $taxonomy->taxonomy]) }}">{{ ucfirst($taxonomy->taxonomy) }} List</a></li>
