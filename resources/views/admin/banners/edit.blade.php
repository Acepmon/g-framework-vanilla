            ...
            <div class="card">
                <div class="card-header header-elements-inline">
                    ...
                    <div class="header-elements">
                        <a href="#modal_banner_remove" data-toggle="modal" class="btn btn-light"><span class="icon-trash mr-2"></span> Delete</a>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group @error('title') has-error @enderror">
                            ...
                            <input type="text" class="form-control" name="title" id="title" placeholder="Winter season sale!... etc" value="{{ $banner->title }}" required>
                            @error('title')
                        ...
                        <div class="form-group @error('link') has-error @enderror" id="link_group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" name="link" id="link" placeholder="https://..." value="{{ $banner->link }}">
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group @error('location') has-error @enderror">
                            ...
                            <select name="location" id="location" class="form-control">
                                @foreach ($locations as $location)
                                    <option value="{{ $location->id }}" {{ $banner->location_id == $location->id ? 'selected' : '' }}>{{ $location->title }}</option>
                                @endforeach
                            </select>
                            @error('location')
                                <div class="help-block text-danger">{{ $message }}</div>
                        ...
                        <div class="form-group @error('banner') has-error @enderror">
                            ...
                            <input type="checkbox" name="banner_remove" id="banner_remove" hidden>
                    ...
                    <fieldset class="content-group">
                        ...
                        <div class="form-group @error('schedule') has-error @enderror">
                            ...
                            <div class="input-group">
                                <input type="text" name="schedule" id="schedule" class="form-control daterange-increments" value="{{ \Carbon\Carbon::parse($banner->starts_at)->format('mm/dd/YYYY h:mm a') . ' - ' . \Carbon\Carbon::parse($banner->ends_at)->format('mm/dd/YYYY h:mm a') }}">
    ...
    function cropWebImage() {
        var canvas = webCropper.getCroppedCanvas().toBlob((blob) => {
            ...
            reader.onloadend = function() {
                ...
                $("#banner_remove").prop('checked', false);
            }
        });
    }
