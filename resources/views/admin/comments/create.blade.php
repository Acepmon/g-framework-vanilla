            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('admin.comments.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="commentable_type" placeholder="Enter commentable type..." required="required" aria-required="true" invalid="true" value="Modules\Content\Entities\Content">
                        </div>
                    </div>
