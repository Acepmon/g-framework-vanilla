                    ...
                    <div class="col-md-12">
                        <div class="card vehicle-info-top shadow-soft-blue">
                            <div class="card-body text-left">
                                <div class="row">
                                    <div class="col-md-9">
                                    <h1 class="vehicle-title">Santa fe The Prime diesel 2.0 2wd</h1>
                ...
                <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/1.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/2.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/3.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/4.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/5.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/6.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/7.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/8.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/9.jpg') }}" alt="">
                        </div>
                        <div class="vi-slider-item">
                            <img src="{{ asset('car-web/img/Cars/10.jpg') }}" alt="">
                        </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="dealer-information">
                                ...
                                <img src="{{ asset('car-web/img/testimonials-2.jpg') }}" alt="" class="img-fluid">
                                </div>
                                <div class="dealer-meta">
                                <div class="dealer-name">Enkhtuvshin</div>
                                <div class="dealer-status">Auto Dealer</div>
                                <div class="dealer-contact"> <i class="icon-phone"></i> +976 9999 9999</div>
                                </div>
                            </div>
                            </div>
                        </div>
