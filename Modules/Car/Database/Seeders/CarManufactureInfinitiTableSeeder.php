...
class CarManufactureInfinitiTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $infinitis = ['Infiniti Q50 (Q50 2.0t Pure, 2.0t Luxe, 3.0t Luxe, 3.0t Sport, Red Sport 400, Hybrid)', 'Infiniti Q60 (Q60 2.0t Pure, 2.0t Luxe, 3.0t Luxe, 3.0t Sport, Red Sport 400)'
        ...
        $parent = TaxonomyManager::register('Infiniti', 'car-manufacturer');

        foreach ($infinitis as $key => $infiniti) {
            TaxonomyManager::register($infiniti, 'car-infiniti', $parent->term->id);
        }
