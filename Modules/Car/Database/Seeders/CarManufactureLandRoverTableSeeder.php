...
class CarManufactureLandRoverTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $landrovers = ['Land Rover', 'Land Rover 101 Forward Control', 'Land Rover DC100', 'Land Rover Defender', 'Land Rover Defender (L663)', 'Land Rover Discovery', 'Land Rover Discovery Series I'
        ...
        $parent = TaxonomyManager::register('Land Rover', 'car-manufacturer');

        foreach ($landrovers as $key => $landrover) {
            TaxonomyManager::register($landrover, 'car-land-rover', $parent->term->id);
        }
