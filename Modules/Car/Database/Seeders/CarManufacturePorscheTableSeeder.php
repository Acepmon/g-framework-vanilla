...
class CarManufacturePorscheTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $porsches = ['Porsche 356 (1948–1965)', 'Porsche 550 (1953–1957)', 'Porsche 718 (1957–1962)', 'Porsche 904 (1963–1965)', 'Porsche 906 (1965–1966)', 'Porsche 911 (1963–present)'
        ...
        $parent = TaxonomyManager::register('Porsche', 'car-manufacturer');

        foreach ($porsches as $key => $porsche) {
            TaxonomyManager::register($porsche, 'car-porsche', $parent->term->id);
        }
