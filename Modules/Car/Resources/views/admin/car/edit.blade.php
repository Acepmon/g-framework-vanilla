...
<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
    <div class="d-flex">
        <div class="breadcrumb">
            ...
            <a class="breadcrumb-item" href="{{ route('admin.modules.car.index') }}">{{ ucfirst($content->type) }}s</a>
            <a class="breadcrumb-item" href="{{ route('admin.modules.car.show', ['id' => $content->id]) }}">Detail</a>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form class="form-horizontal form-validate-jquery" action="{{ route('admin.modules.car.update', ['id' => $content->id]) }}" enctype="multipart/form-data" method="POST">
                    @method('PUT')
                    @csrf
